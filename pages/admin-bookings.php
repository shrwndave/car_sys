<?php
	...
	$page_info['page'] = 'bookings'; //for page that needs to be called
	$page_info['sub_page'] = isset($_GET['sub_page'])? $_GET['sub_page'] : 'bookings'; //for function to be loaded
